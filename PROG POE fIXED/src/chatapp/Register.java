...
public class Register extends JPanel {
	...
	public void registerUser(Main main) {
		...
		if(userLog.checkUserName(userName.getText()) == true) {
			JOptionPane.showInternalMessageDialog(null, "Username successfully captured", "Error", JOptionPane.INFORMATION_MESSAGE);
		}
		else {
		...
		if(userLog.checkPasswordComplexity(passWord.getText()) == true) {
			JOptionPane.showInternalMessageDialog(null, "password successfully captured", "Error", JOptionPane.INFORMATION_MESSAGE);
		}
		else {
		...
		if(userLog.checkCellPhoneNumber(cellNum.getText()) == true) {
			JOptionPane.showInternalMessageDialog(null, "Cell phone number successfully added", "Error", JOptionPane.INFORMATION_MESSAGE);
		}
		else {
